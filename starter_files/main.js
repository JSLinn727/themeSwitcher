...
function kittenTheme() {
  ...
  document.querySelector('p').textContent = 'A kitten, also known as a kitty or kitty cat, is a juvenile cat. After being born, kittens are totally dependent on their mother for survival and they do not normally open their eyes until after seven to ten days.'
...
function tokyoTheme() {
  ...
  document.querySelector('p').textContent = 'The Neo Tokyo aesthetic has permeated some of the biggest films and novels of the last 40 years, including Blade Runner and Akira.'
...
function metalTheme() {
  ...
  document.querySelector('p').textContent = 'Heavy metal (or simply metal) is a genre of rock music that developed in the late 1960s and early 1970s, largely in the United Kingdom and the United States.'
